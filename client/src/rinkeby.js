...
const contractAddress = "0xF813D32069D07dCC336A101f21eEc503225B2f64";
...
async function generateAccessToken() {
  let fromBCtoken = await contract.methods.getCarRenter(carId).call();
  console.log("OWNER IS:", fromBCtoken);
...
async function logic(n) {
  switch (n) {
    ...
    case 10:
      // --------------------------------Withdraw money------------------------------------------------------------------------------------------------------
      const myData10 = contract.methods
        .withdrawMoneyToRenter(carId)
        .encodeABI();
